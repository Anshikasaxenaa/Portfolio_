export const projects = [
  {
    ...
    title: "DocuWise",
    description:
      "A full-stack AI-powered document management platform that enables users to securely upload, organize, summarize, and interact with documents using intelligent AI features. Built with Next.js, Node.js, Express, MongoDB, and Gemini AI.",
    problem:
      "Managing large collections of documents and extracting key information manually is time-consuming. Existing solutions often lack AI-powered insights, secure authentication, and an intuitive document organization system.",
    solution:
      "DocuWise combines secure JWT and Google OAuth authentication with AI-powered document summarization, intelligent search, and efficient document management in a modern, responsive interface, helping users quickly organize and understand their documents.",
    tags: [
      "Next.js",
      "React",
      "TypeScript",
  ...
  },
  {
    ...
    title: "Katacut",
    description:
      "A privacy-first subscription tracker that securely analyzes your bank statements on-device to help you find and cancel forgotten subscriptions.",
    problem:
      "People lose hundreds of dollars annually to forgotten subscriptions and hidden recurring charges. Finding these charges usually means tedious manual review of bank statements, and most automated financial apps compromise privacy by uploading your sensitive financial data to the cloud for analysis.",
    solution:
      "KataCut offers a secure, zero-knowledge approach by processing bank PDFs and SMS alerts entirely client-side using Web Workers. It uses smart detection algorithms to identify recurring charges and provides a one-click assistant to generate cancellation emails, ensuring your financial data never leaves your device.",
    tags: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
    ...
    githubLink: "https://github.com/Anshikasaxenaa/KataCut",
    liveLink: "https://kata-cut.vercel.app/",
  },
  {
    id: 3,
    title: "PrepAI - AI-Powered Interview Platform",
    description:
      "An intelligent mock interview platform using large language models. It provides real-time feedback, analyzes facial expressions, and generates dynamic technical questions based on the candidate's resume.",
    problem:
      "Candidates often struggle with interview anxiety and lack realistic, personalized practice environments before crucial job interviews.",
    solution:
      "An intelligent platform that simulates real interviews, analyzes facial expressions, and dynamically tailors technical questions to the user's resume.",
  ...
  },
  {
    ...
    problem:
      "Standard portfolios often feel static and fail to communicate a developer's unique design sensibilities and engineering rigor.",
    solution:
      "A deeply interactive, server-side rendered application utilizing advanced Framer Motion choreography and a warm editorial aesthetic to stand out.",
  ...
  },
  {
    ...
    title: "Post App",
    description:
      "A full-stack social media application enabling users to share visual stories. Features secure authentication, real-time image processing, and a highly responsive masonry layout.",
    problem:
      "Users needed a highly responsive, secure platform to share visual stories without compromising on image load times or layout stability.",
    solution:
      "A full-stack social application with real-time image processing, secure JWT authentication, and a dynamic masonry layout for seamless browsing.",
...
export const aboutContent = {
  statement:
    "I believe digital products should feel like a conversation — intelligent, intuitive, and deeply human.",
  ...
  pillars: [
    {
      title: "Craft",
      description:
        "Treating every line of code as an opportunity to build robust, scalable architectures.",
      shape: "circle",
    },
    {
      title: "Clarity",
      description:
        "Distilling complex algorithmic problems into elegant, intuitive digital solutions.",
      shape: "square",
    },
    {
      title: "Curiosity",
      description:
        "Constantly exploring the frontiers of Agentic AI, DevOps, and cloud technologies.",
      shape: "line",
    },
  ],
  personal: {
...
export const achievementsData = [
  {
    ...
    date: "Current",
    details:
      "Strengthened problem-solving, algorithms, and data structure skills using Java.",
  },
];
...
export const certificationsData = [
  {
    ...
    date: "Dec 2025",
    details:
      "Completed practical tasks in Project Setup, Kafka Integration, H2 Integration, and REST API development.",
  },
  {
    id: 2,
    ...
    date: "Sep 2025",
    details:
      "Demonstrated proficiency in executing Create, Read, Update, and Delete operations in MongoDB.",
  },
  {
    id: 3,
    ...
    date: "Jun 2025",
    details:
      "Successfully completed the comprehensive Artificial Intelligence course.",
  },
  {
    id: 4,
