export const projects = [
  ...
  },
  {
    id: 2,
    title: "Katacut",
    description: "A privacy-first subscription tracker that securely analyzes your bank statements on-device to help you find and cancel forgotten subscriptions.",
    problem: "People lose hundreds of dollars annually to forgotten subscriptions and hidden recurring charges. Finding these charges usually means tedious manual review of bank statements, and most automated financial apps compromise privacy by uploading your sensitive financial data to the cloud for analysis.",
    solution: "KataCut offers a secure, zero-knowledge approach by processing bank PDFs and SMS alerts entirely client-side using Web Workers. It uses smart detection algorithms to identify recurring charges and provides a one-click assistant to generate cancellation emails, ensuring your financial data never leaves your device.",
    tags: ["Next.js", "TypeScript", "Tailwind CSS", "MongoDB", "Web Crypto API"],
    image: "/project-6.png", 
